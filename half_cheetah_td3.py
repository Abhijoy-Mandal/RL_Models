...
def compute_loss(experiences, gamma, q_network, target_q_network, policy_network, alt_q_net):
    ...
    a_prime, _ = get_action(means, 0.2)
...
if __name__=='__main__':
    ...
    # policy = tf.keras.models.load_model('half_cheetah_policy_td3.h5')
    # q_network = tf.keras.models.load_model('half_cheetah_q1_td3.h5')
    # q_network_2 = tf.keras.models.load_model('half_cheetah_q2_td3.h5')
    ...
    for i in range(num_episodes):
        ...
        if (i + 1) % num_p_av == 0:
            ...
            policy.save('half_cheetah3_policy_td3_2.h5')
            q_network.save('half_cheetah3_q1_td3_2.h5')
            q_network_2.save('half_cheetah3_q2_td3_2.h5')
