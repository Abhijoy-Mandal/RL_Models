...
def evaluate(eps, score):
    ...
    writer = imageio.get_writer(f'./walker_Vids_ppo/episode_{eps}_{score}.mp4', fps=60)
    state, _ = env.reset()
    tot_reward = 0
    ...
    while i < num_episodes:
        ...
        for j in range(batch_size):
            ...
            if done:
                ...
                if score>max_score:
                    actor_network.save('walker_ppo_actor_max_4.h5')
                    critic_network.save('walker_ppo_critic_max_4.h5')
                    max_score=score
                score = 0
                state, _ = env.reset()
                if (i+1)%10==0:
        ...
        actor_network.save('walker_ppo_actor_9.h5')
        critic_network.save('walker_ppo_critic_9.h5')
    env.close()