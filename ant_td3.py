...
from tensorflow.keras.layers import Dense, Input, InputLayer, Conv2D, MaxPool2D, Flatten, BatchNormalization
...
def compute_loss(experiences, gamma, q_network, target_q_network, policy_network, alt_q_net):
    ...
    a_prime, _ = get_action(means, 0.3)
...
def evaluate(eps, score, max_score):
    ...
    writer = imageio.get_writer(f'./and_mujoco/episode_{eps}_{score}_{max_score}.mp4', fps=30)
    state, _ = env.reset()
    tot_reward = 0
...
if __name__=='__main__':
    ...
    policy = tf.keras.models.load_model('ant_policy_td3_max4.h5')
    q_network = tf.keras.models.load_model('ant_q2_td3_max4.h5')
    q_network_2 = tf.keras.models.load_model('ant_q1_td3_max4.h5')
    ...
    for i in range(num_episodes):
        ...
        if total_points>max_score:
            ...
            policy.save('ant_policy_td3_max5 .h5')
            q_network.save('ant_q1_td3_max5.h5')
            q_network_2.save('ant_q2_td3_max5.h5')
        ...
        if (i + 1) % 10 == 0:
            ...
            policy.save('ant_policy_td3_9.h5')
            q_network.save('ant_q1_td3_9.h5')
            q_network_2.save('ant_q2_td3_9.h5')
